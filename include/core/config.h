...
/* 处方发药状态 */
#define PR_STATUS_UNDISPENSED 0                     // 未发药
#define PR_STATUS_DISPENSED 1                       // 已发药
#define PR_STATUS_COUNT 2                           // 处方发药状态数量
extern const char *PR_STATUS_TEXT[PR_STATUS_COUNT]; // 处方发药状态文本描述数组
